...
{
  processFile("src/main.c", "test.c");
  return 0;
}
# 0 "src/preprocessor.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/preprocessor.c"
# 1 "src/preprocessor.h" 1
...
# 4 "src/preprocessor.c" 2
# 1 "src/assets/hashMap.h" 1
       


# 3 "src/assets/hashMap.h"
...
# 5 "src/preprocessor.c" 2

void includeFiles(FILE *ifp, FILE *ofp);
...
# 0 "src/assets/hashMap.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/assets/hashMap.c"
# 1 "src/assets/hashMap.h" 1
...
# 4 "src/assets/hashMap.c" 2
# 1 "src/assets/utils.h" 1
       




# 5 "src/assets/utils.h"
void* myAllocMemory(unsigned int size);
# 5 "src/assets/hashMap.c" 2
# 1 "src/assets/myString.h" 1
       

int myStrCmp(char *str1, char *str2);
unsigned long myStrGetLen(char *str);
void myStrCpy(char *str, char **buf);
# 6 "src/assets/hashMap.c" 2
...
HashMap* HMinit(unsigned long nop)
{
  ...
  if (!out)
    return 
# 21 "src/assets/hashMap.c" 3 4
          ((void *)0)
# 21 "src/assets/hashMap.c"
              ;
  ...
  if (!out->map) {
    free(out);
    return 
# 26 "src/assets/hashMap.c" 3 4
          ((void *)0)
# 26 "src/assets/hashMap.c"
              ;
  }

  for (int i = 0; i < nop; i++) {
    out->map[i] = (HMpocket) {
# 30 "src/assets/hashMap.c" 3 4
                             ((void *)0)
# 30 "src/assets/hashMap.c"
                                 , 
# 30 "src/assets/hashMap.c" 3 4
                                   ((void *)0)
# 30 "src/assets/hashMap.c"
...
HMPnode* HMPNinit(char *key, char *val)
{
  ...
  if (!out)
    return 
# 87 "src/assets/hashMap.c" 3 4
          ((void *)0)
# 87 "src/assets/hashMap.c"
              ;
  ...
  if (!out->key) {
    free(out);
    return 
# 92 "src/assets/hashMap.c" 3 4
          ((void *)0)
# 92 "src/assets/hashMap.c"
              ;
  }
  ...
  if (!out->val) {
    ...
    free(out);
    return 
# 99 "src/assets/hashMap.c" 3 4
          ((void *)0)
# 99 "src/assets/hashMap.c"
              ;
  }
  ...
  out->next = 
# 105 "src/assets/hashMap.c" 3 4
             ((void *)0)
# 105 "src/assets/hashMap.c"
                 ;
...
HMPnode* HMPfind(HMpocket *pocket, char *key)
{
  ...
  return 
# 119 "src/assets/hashMap.c" 3 4
        ((void *)0)
# 119 "src/assets/hashMap.c"
            ;
}
...
void HMdelete(HashMap *hm, char *key)
{
  ...
  HMPnode *prev = 
# 170 "src/assets/hashMap.c" 3 4
                 ((void *)0)
# 170 "src/assets/hashMap.c"
                     ;
...
# 0 "src/assets/myString.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/assets/myString.c"
# 1 "src/assets/myString.h" 1
...
# 0 "src/assets/utils.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/assets/utils.c"
# 1 "src/assets/utils.h" 1
...
# 4 "src/assets/utils.c" 2


# 5 "src/assets/utils.c"
void* myAllocMemory(unsigned int size)
{
  int try = 0;
  void *res = 
# 8 "src/assets/utils.c" 3 4
             ((void *)0)
# 8 "src/assets/utils.c"
                 ;
