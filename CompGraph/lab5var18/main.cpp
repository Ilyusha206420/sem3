...
int main() 
{
  ...
  geometry.createFace({0, 1, 2, 3}, 255, 0, 0, 255);
  geometry.createFace({0, 1, 5, 4}, 0, 255, 0, 255);
  geometry.createFace({1, 2, 6, 5}, 0, 0, 255, 255);
  geometry.createFace({2, 3, 7, 6}, 255, 255, 0, 255);
  geometry.createFace({0, 3, 7, 4}, 0, 255, 255, 255);
  geometry.createFace({4, 5, 6, 7}, 255, 0, 255, 255);
